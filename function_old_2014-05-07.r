...
gene.data.family <- function(m=1, var=0, f=0.01, SRR=5, p_dis=0.01, n_family=1000) {
  ...
  ##generate sibpairs
  data_family <- array(NA, c(n_family, 25))
  n_family_count <- 1
 ...
 #   if(dis==1 & !(H1_f==0 & H2_f==0 & H1_m==0 & H2_m==0) & !(H1_f==1 & H2_f==1 & H1_m==1 & H2_m==1)) {
    if(dis==1) {
      ...
      data_family[n_family_count,] <- c(H1_f=H1_f, H1_rr_f=H1_rr_f, H2_f=H2_f, H2_rr_f=H2_rr_f, 
                 H1_m=H1_m, H1_rr_m=H1_rr_m, H2_m=H2_m, H2_rr_m=H2_rr_m,
                                 H1=H1, H1_rr=H1_rr, H2=H2, H2_rr=H2_rr,
                                 H1_s=H1_s, H1_rr_s=H1_rr_s, H2_s=H2_s, H2_rr_s=H2_rr_s,
                                 S=S,S0=S0, S1=S1, S2=S2, S11=S11, S12=S12,
                                 penetrance=penetrance, dis=dis, T_stat=T_stat)
...
test <- gene.data.family(m=1, var=0, f=0.01, SRR=5, n_family=100)
