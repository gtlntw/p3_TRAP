...
opts['f'] = 0.01 #rare
for i in numpy.arange(1,3.3,0.1):
...
result <- read.csv("appendix figure 2. correct trap and trafic_ext compare with pedgene, cc, and fbat_ext 2g2a_at p_dis0.1.csv", header=T)
