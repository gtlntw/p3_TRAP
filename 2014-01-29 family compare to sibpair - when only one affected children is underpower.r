...
affect <- c(1,1,0,1)
p_dis=0.1 #baselinbe is 0.01, the other option is 0.1

#fn <- power.family.2 #calculate only 0 and 1 variant in founders and dump 0
#fn <- power.family.3 #calculate only 0,1,2,3,4 variant in founders and dump 0 and 4
fn <- power.family.4 #calculate only 0,1,2,3,4 variant in founders and dump 0 and 4, fix sibling affected status
