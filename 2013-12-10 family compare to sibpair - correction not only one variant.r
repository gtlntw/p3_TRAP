...
curve(sapply(x, function(x) power.family.all(mu=x, f=0.01, n_family=n1/2)), col="seagreen3", add=TRUE, lwd=lwd)
...
curve(sapply(x, function(x) power.family.all(mu=x, f=0.05, n_family=n1/2)), col="seagreen3", add=TRUE, lwd=lwd)
...
curve(sapply(x, function(x) power.family.all(mu=x, f=0.2, n_family=n1/2)), col="seagreen3", add=TRUE, lwd=lwd)
