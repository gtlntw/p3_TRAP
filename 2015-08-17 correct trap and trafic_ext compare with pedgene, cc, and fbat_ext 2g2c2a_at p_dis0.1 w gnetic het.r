...
colnames(result.df) <- c("result.trap.2g2c2a", "result.trafic_ext.2g2c2a", 
                         ...
                         "result.fbskat.vc.2g2c2a", "result.fbskat.burden.2g2c2a",
                         "result.cc")
result.df <- cbind(seed,r,p_dis,paste(risk.variant,collapse="-"),risk.haplo.f,n_family,result.df)
...
result <- read.csv("2015-08-17 correct trap and trafic_ext compare with pedgene, cc, and fbat_ext 2g2c2a_at p_dis0.1 w gnetic het.csv", header=T)
