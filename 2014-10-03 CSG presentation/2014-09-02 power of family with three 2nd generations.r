...
plot(unique(result_0.01$r), tapply(result_0.01$p_value<alpha, result_0.01$r, mean), col=1, lty=1, lwd=lwd, type="l", xlab="mean relative risk", ylab="power", cex=cex, cex.axis=cex, cex.lab=cex)
lines(unique(result_3rd_0.01$r), tapply(result_3rd_0.01$p_value<alpha, result_3rd_0.01$r, mean), col="darkgoldenrod2", lty=1,lwd=lwd)
lines(unique(result_three2nd_0.05_0.01$r), tapply(result_three2nd_0.05_0.01$p_value<alpha, result_three2nd_0.05_0.01$r, mean), col="dodgerblue3", lty=1,lwd=lwd)
...
legend("bottomright", c("two generations 2:2:0", "three generations 2:2:1", "additional child 2:3:0"), col=c(1,"darkgoldenrod2","dodgerblue3"), lty=1, cex=cex, lwd=lwd)
